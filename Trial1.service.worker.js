...
const CACHE_NAME = "Trial1-cache";
const OFFLINE_URL = "Trial1.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Trial1.html","Trial1.js","Trial1.wasm","Trial1.pck","Trial1.offline.html","Trial1.icon.png","Trial1.apple-touch-icon.png"];
